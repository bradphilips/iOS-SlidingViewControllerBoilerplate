...
+ (CGFloat)rowHeight
{
	...
	NSNumber *rowHeight =
		rowHeightsForClasses ?
			(__bridge NSNumber *)CFDictionaryGetValue(rowHeightsForClasses, (__bridge const void *)(self)) : nil;
	if (rowHeight == nil)
	{
		...
		if (nibName)
		{
			...
			PageCell *cellInstance = [[[self class] alloc] init];
			[[NSBundle mainBundle]
			...
			CFDictionaryAddValue(rowHeightsForClasses, (__bridge void*) self, (__bridge void*) rowHeight);
		}
		else
		{
